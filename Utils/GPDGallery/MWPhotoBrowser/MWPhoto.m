...
caption = _caption,thumbName=_thumbName,description=_description;
...
+ (MWPhoto *)photoWithFilePath:(NSString *)path description:(NSString *)desc {
	return [[[MWPhoto alloc] initWithFilePath:path description:desc] autorelease];
}
...
- (id)initWithFilePath:(NSString *)path description:(NSString *)desc {
	if ((self = [super init])) {
